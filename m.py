...
# 🛠️ BOT CONFIGURATION
# ======================
TOKEN = '8064557178:AAFptziPNr_RQGilnIasD4ltXS5Bvmg9Asw'
OWNER_USERNAME = "RAVI_BoSs_OwN"
ADMIN_IDS = ["RAVI_BoSs_OwN", "R_SDANGER2"]  # Add admin usernames here
ALLOWED_GROUP_IDS = [-1002814195538]
MAX_THREADS = 900
...
@bot.message_handler(func=lambda msg: msg.text == "🌐 𝘼𝘾𝙏𝙄𝙑𝘼𝙏𝙀 𝙋𝙐𝘽𝙇𝙄??")
